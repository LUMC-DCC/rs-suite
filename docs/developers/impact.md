...
<!-- generated:start -->
## When Albinusnet - Research Software Stewardship (internal) changes
...
## When Research software training › Coding Cafe changes
...
- **[rs-files-templates](https://lumc-dcc.github.io/rs-files-templates/)**: Update integration if file-generation APIs, variables or output contracts change.
- **[rsm-schema](https://lumc-dcc.github.io/rsm-schema/)**: Propose schema changes if rs-tools introduces genuinely new structured concepts.
...
- **[rs-tools](https://rs-tools.onrender.com/)**: Update integration when template inputs or output contracts change.
- **[rs-metadata](https://lumc-dcc.github.io/rs-metadata/)**: Update validation expectations when metadata-file structure/content changes.
...
- **[rs-tools](https://rs-tools.onrender.com/)**: Update generator integration if Cookiecutter variables, template names or invocation change.
- **[rs-metadata](https://lumc-dcc.github.io/rs-metadata/)**: Review validation/CI assumptions if generated metadata or workflow files change.
...
- **[rs-files-templates](https://lumc-dcc.github.io/rs-files-templates/)**: Update generated examples/templates when validator requirements or supported profiles change.
...
- **[Metadata bridge](https://github.com/bio-tools/metadata-bridge)**: Review field mapping if repository metadata normalization changes affect bridge inputs.
...
- **[Metadata bridge](https://github.com/bio-tools/metadata-bridge)**: Update extraction logic when repository metadata locations/formats change.
- **[rs-metadata](https://lumc-dcc.github.io/rs-metadata/)**: Update validation/normalization rules for new repository conventions.
...
- **[rs-metadata](https://lumc-dcc.github.io/rs-metadata/)**: Review extraction rules when repository metadata conventions change.
...
- **[rsm-schema](https://lumc-dcc.github.io/rsm-schema/)**: Update mapping if the bridge changes its RSM representation or extracts new RSM fields.

## When bio.tools registry changes

- **Metadata bridge › GitHub ↔ bio.tools bridge**: Update API client, authentication, field mapping and sync logic after API/schema changes.
...
- **Metadata bridge › GitHub ↔ bio.tools bridge**: Update client integration if endpoints, payloads, conflict representation or merge semantics change.
- **[rsm-schema](https://lumc-dcc.github.io/rsm-schema/)**: Add adapters/tests only if schema-specific behavior is introduced.
<!-- generated:end -->
